...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GamesBoxd_api.Domain.Entities.Backlog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GamesBoxd_api.Domain.Entities.BacklogGame", b =>
                {
                    ...
                    b.HasKey("BacklogId", "GameId");

                    b.HasIndex("GameId");

                    b.ToTable("backlog_game", (string)null);
                });
            ...
            modelBuilder.Entity("GamesBoxd_api.Domain.Entities.Backlog", b =>
                {
                    b.HasOne("GamesBoxd_api.Domain.Entities.User", "User")
                        .WithOne("Backlog")
                        .HasForeignKey("GamesBoxd_api.Domain.Entities.Backlog", "UserId")
            ...
            modelBuilder.Entity("GamesBoxd_api.Domain.Entities.BacklogGame", b =>
                {
                    b.HasOne("GamesBoxd_api.Domain.Entities.Backlog", "Backlog")
